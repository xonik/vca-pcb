...
<text x="50.8" y="134.62" size="5.08" layer="91">V1.0 of this circuit has two
shortcomings:
- an input may only go to a single output
- the sum of the waves may only reach
  approx 8V or the input on SUM A/B will clip</text>
</plain>
<instances>
